...
# install script
sudo cp ./update-monitor-position /usr/local/sbin/update-monitor-position
sudo chmod +x /usr/local/sbin/update-monitor-position

# install desktop launcher
sudo cp ./update-monitor-position.desktop /usr/share/applications/update-monitor-position.desktop
